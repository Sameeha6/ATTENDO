...
const NotificationPage = () => {
  ...
  const fetchNotifications = (parentId, studentId) => {
    axios.get(`http://127.0.0.1:8000/api/notifications/parent/${parentId}/?student_id=${studentId}`)
      .then((response) => {
      ...
      <div className="space-y-4 overflow-y-auto max-h-[80vh]">
        {notifications.map((notification, index) => (
          <div key={index}
            ...
            <button className="mr-2 sm:mr-3 text-gray-400 hover:text-gray-600 shrink-0"
