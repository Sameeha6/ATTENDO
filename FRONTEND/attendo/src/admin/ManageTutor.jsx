  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-md">
      ...
      <div className="bg-gray-100 p-4 rounded-md mb-6">
        <h3 className="text-xl font-semibold mb-3">Create Tutor</h3>
      ...
      {/* All HODs Table */}
      <h3 className="text-xl font-semibold mb-3">All Tutors</h3>
        ...
        <table className="w-full border-collapse border">
          ...
          <tbody>
            <tr className="text-center">
              ...
              <td className="border p-2">Sebastin</td>
              <td className="border p-2">samseb@example.com</td>
