...
const AdminDashboard = () => {
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
      ...
      <div className="bg-white p-6 shadow-lg rounded-lg flex items-center gap-4">
        <MdOutlineClass className="text-blue-900 text-4xl" />
        <div>
          <h3 className="text-xl font-bold">Classes</h3>
          <p className="text-gray-700">Total: 20</p>
        </div>
      </div>

      <div className="bg-white p-6 shadow-lg rounded-lg flex items-center gap-4">
        <FaUserTie className="text-blue-900 text-4xl" />
        <div>
          <h3 className="text-xl font-bold">HOD</h3>
