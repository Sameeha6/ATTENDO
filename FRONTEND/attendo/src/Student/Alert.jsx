...
const alerts = [
  {
    ...
    message: "Your attendance has fallen below the required 75%. Immediate action is needed to avoid academic penalties.",
    borderColor: "border-red-500",
  },
  {
    sender: "WARNING",
    time: "10:30 AM, 24 Feb 2025",
    message: "Your attendance is close to falling below the required 75%. Ensure regular attendance to stay compliant.",
